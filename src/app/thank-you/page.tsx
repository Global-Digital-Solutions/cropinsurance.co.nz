...
export const metadata: Metadata = { title: 'Thank You | CropInsurance.co.nz', description: 'Thank you for your enquiry. Use the information on this site to prepare for your conversation with an insurer or broker.' };
