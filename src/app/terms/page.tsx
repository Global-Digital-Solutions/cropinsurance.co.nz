        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="space-y-8 text-sm text-gray-700 leading-relaxed">
            ...
            <div>
              ...
              <p>Any references to the types of insurers and brokers active in the NZ crop insurance market are for general informational purposes only. CropInsurance.co.nz is not affiliated with, endorsed by, or acting as an agent for any specific insurer. Our partner brokers work across multiple insurers and act in your interest to find appropriate coverage.</p>
            </div>
