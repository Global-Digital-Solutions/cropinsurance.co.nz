...
export const providers: Provider[] = [
  ...
  {
    slug: 'ajg',
    name: 'AJG – Arthur J. Gallagher NZ',
    shortName: 'AJG / Gallagher',
    logo: 'https://logo.clearbit.com/ajg.co.nz',
    rating: 4.5,
    reviewCount: 187,
    description: 'A global insurance broker with a strong New Zealand rural and agribusiness practice. AJG can access specialist international crop insurance markets alongside domestic insurers, providing broader coverage options for large-scale growers.',
  ...
  },
  {
    ...
    shortName: 'Aon',
    logo: 'https://logo.clearbit.com/aon.co.nz',
    rating: 4.4,
    reviewCount: 156,
  ...
  },
  {
    ...
    shortName: 'Farmcover',
    logo: 'https://logo.clearbit.com/farmcover.co.nz',
    rating: 4.3,
    reviewCount: 98,
  ...
  },
  {
    ...
    shortName: 'Howden',
    logo: 'https://logo.clearbit.com/howdengroup.com',
    rating: 4.3,
    reviewCount: 74,
