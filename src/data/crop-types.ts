...
<p>Following a hailstorm, frost, or other covered event, notify your insurer or broker as soon as practicable — ideally within 24–48 hours. Most specialist rural insurers will deploy a crop loss assessor quickly following a weather event. The assessor will inspect the orchard, document the damage, and estimate the likely yield impact. For hail damage, this process often occurs both immediately after the event (to document the damage) and again at harvest (to assess the final yield reduction). Keeping detailed crop records — historical yield data, spray records, and growing management records — significantly speeds up the claims process and supports the assessment of your actual loss.</p>
    ...
    faqs: [
      { q: 'Does kiwifruit insurance cover PSA disease?', a: 'PSA (Pseudomonas syringae pv. actinidiae) is typically excluded from standard named perils crop insurance because it is a biological disease rather than a weather event. However, business interruption cover can compensate for income lost during a PSA-forced replanting programme, and some specialist international market policies offer limited disease or re-establishment cover. Speak with a specialist broker specifically about PSA risk and they will identify what coverage options are available for your orchard.' },
      { q: 'What is the typical kiwifruit insurance premium in NZ?', a: 'Premiums typically range from 1% to 3.5% of the insured crop value. Orchards with overhead hail netting receive substantial discounts on hail cover. Contact a specialist crop insurance broker for an accurate quote specific to your operation, variety, and region.' },
      ...
      { q: 'What is the difference between Gold and Green kiwifruit insurance rates?', a: 'Gold3 (SunGold) kiwifruit typically commands higher per-tray prices than Green, resulting in a higher insured value per hectare and therefore higher absolute premiums. However, the premium rate (as a percentage of insured value) may be similar between varieties. Gold3 orchards in PSA-risk areas may face loading due to biosecurity exposure. A specialist broker can provide variety-specific quotes reflecting the current market value of your crop.' },
    ],
  },
  {
...
<p><strong>Infrastructure cover</strong> for hail netting, bins, coolstore, packhouse, and irrigation systems should complement crop cover. A specialist broker can combine crop and property cover into a single coordinated rural package.</p>
    `,
...
<p>For larger vineyard operations and estate wineries, revenue protection policies can guarantee a minimum income even in a catastrophic season. Business interruption cover is particularly valuable where a major weather event or vine disease requires an extended recovery period — for example, a frost event that destroys an entire vintage's income while debt servicing and operational costs continue. A specialist broker can structure layered coverage that combines named perils crop cover, stored wine cover, and business interruption into a coherent protection programme.</p>
...
<p>The standard NZ arable crop insurance framework is built around named perils cover. Policies typically cover growing and harvested crops against fire and lightning as the base, with optional extensions for hail, frost (from 15 November), windstorm, and vehicle or aircraft impact. Harvested crop can be covered for up to 12 months from the date of harvest or until sold, providing protection for grain in on-farm storage before it is delivered to the buyer.</p>

<p>A particularly valuable provision in many arable policies is the replanting benefit: if a covered loss occurs within 40 days of planting, the insurer will pay 80% of the reasonable cost of replanting the damaged area in the same crop. This is especially relevant for early-sown winter wheat or barley that suffers waterlogging or flooding shortly after establishment, allowing growers to replant without bearing the full input cost again.</p>

<p>For growers with significant scale and financial exposure, multi-peril crop insurance (MPCI) provides broader protection. MPCI guarantees a minimum yield or revenue regardless of the cause of loss — including drought, which is excluded from named perils policies. MPCI is typically accessed through international markets via specialist brokers with access to international insurance markets.</p>
...
<p><strong>Late frosts</strong> after sowing can damage young crop plants, particularly winter barley sown in May–June that is vulnerable to hard frost before it develops frost hardiness. Frost cover under most arable policies applies from 15 November, protecting crops during their most vulnerable spring growth stages.</p>
...
<h3>Typical Premium Costs for Arable Crop Insurance</h3>
    ...
    faqs: [
      { q: 'What does a standard arable crop insurance policy cover?', a: 'A standard arable crop policy covers growing and harvested crops for fire and lightning as standard, with optional extensions for hail, frost (from 15 November), windstorm, and vehicle or aircraft impact. Harvested crop is typically covered for up to 12 months from harvest or until sold. A replanting benefit may pay 80% of reasonable replanting costs if a loss occurs within 40 days of planting. A specialist broker can source cover from specialist crop insurance markets.' },
      { q: 'Is multi-peril crop insurance available for NZ grain growers?', a: 'Yes, though it is less commonly taken than named perils cover. Multi-peril crop insurance (MPCI) guarantees a minimum yield or revenue regardless of the cause of loss, including drought — which named perils policies typically exclude. MPCI is accessed through specialist international markets via specialist brokers with access to international markets. It is most appropriate for large arable operations with significant input costs and financial exposure.' },
      { q: 'Does grain crop insurance cover drought?', a: 'Standard named perils policies do not cover drought. Drought cover requires either a multi-peril crop insurance (MPCI) policy or a parametric drought product (which pays out based on rainfall deficits measured at a local weather station). Both options are available through specialist brokers. If drought is a key risk for your region and crop mix, ask a specialist broker specifically about drought cover options.' },
      ...
      { q: 'What is the replanting benefit in an arable crop policy?', a: 'If a covered loss occurs within 40 days of planting, many arable policies will pay 80% of the reasonable cost of replanting the same crop in the damaged area. This provision is particularly valuable for winter wheat and barley that suffers waterlogging or flooding shortly after establishment, allowing growers to replant without bearing the full input cost again.' },
      { q: 'When should I arrange grain crop insurance?', a: 'Cover should be in place before sowing. For winter crops (barley, oats, wheat), this typically means cover arranged in April–May. For spring crops (spring wheat, maize, peas), cover should be in place before September sowings. Waiting until after sowing — or after a weather event has been forecast — will typically result in insurers declining to provide cover. A specialist broker can arrange cover quickly to meet pre-sowing deadlines.' },
    ],
  },
  {
...
<p>Maize is frost-sensitive, particularly at emergence and during the early vegetative stages. A late frost event in October or November — when recently emerged maize seedlings are just above the ground — can kill the growing points of young plants, requiring replanting or resulting in a significantly delayed crop. Frost at emergence is most relevant for early-planted maize in cooler areas of the Waikato and South Auckland. Many arable policies include a replanting provision (up to 80% of replanting costs within 40 days) that is directly applicable to frost-killed maize establishment.</p>
...
<h3>Premium Guidance for Maize Insurance</h3>
    ...
    faqs: [
      { q: 'Does maize insurance cover drought losses?', a: 'Standard named perils policies do not cover drought. Drought cover requires either a multi-peril crop insurance (MPCI) product, a parametric drought product (which pays out based on rainfall deficits at a weather station), or a specific drought endorsement. Given that summer drought is the most significant risk for NZ maize growers, we strongly recommend discussing drought cover options with a specialist crop insurance broker when arranging your policy.' },
      { q: 'Can I insure a silage maize contract?', a: 'Yes. Contract fulfilment protection can be arranged for silage maize growers who supply dairy farms under contracted volume agreements. This cover can include the cost of sourcing alternative silage to meet contracted deliveries following an insured crop failure. This is a specialist cover — ask a specialist broker specifically about contract fulfilment options for your supply agreements.' },
      { q: 'Is late frost covered by maize insurance?', a: 'Frost cover can be included in named perils maize policies, typically applying from emergence through early vegetative stages. A frost event that kills young maize plants may trigger the replanting provision — many policies pay 80% of reasonable replanting costs if a covered loss occurs within 40 days of planting. This provision directly applies to frost-killed maize establishment in affected paddocks.' },
      { q: 'What is parametric drought insurance for maize?', a: 'Parametric drought insurance pays out when rainfall at a nominated weather station falls below a defined threshold over a specified measurement period — for example, less than 150mm over the December–February quarter. Payment is automatic when the threshold is met, without requiring an on-farm crop assessment. This simplifies claims but may not perfectly match your individual farm\'s yield impact. A specialist broker can help you evaluate whether parametric or traditional drought cover is better suited to your operation.' },
...
<p>Trellis infrastructure should be insured as rural property (farm buildings and structures) on a replacement cost basis, separately from the standing crop. Specialist brokers regularly help Nelson and Tasman hop growers structure combined policies that cover both the trellis infrastructure and the annual crop in a single package, often achieving better total coverage than insuring each element through different insurers.</p>
...
<p>Quality insurance is typically offered as an endorsement to a standard named perils crop policy, rather than as a standalone product. When arranging barley insurance, explicitly ask a specialist broker about quality protection endorsements if you have malting barley under contract.</p>

<h3>Harvested Barley in Storage</h3>

<p>Some arable crop policies cover harvested barley for up to 12 months from the date of harvest or until sold. This provides valuable protection for barley held in on-farm silos or bunkers awaiting sale — a common situation as growers manage their marketing strategy throughout the season. Fire, storm damage to storage structures, and contamination events affecting stored grain are the primary risks covered by harvested crop cover.</p>
...
<h3>Premium Guidance for Barley Insurance</h3>
    ...
    faqs: [
      ...
      { q: 'Does harvested barley in my silo get covered?', a: 'Yes. Many arable crop policies cover harvested barley for up to 12 months from harvest or until sold. This protects barley held in on-farm silos, bunkers, or other storage against fire, storm damage to the storage structure, and other covered events. Given that many Canterbury growers store barley on-farm and sell progressively throughout the season, this harvested crop cover is an important part of the total policy.' },
      { q: 'Is specialist malting barley insurance available?', a: 'Yes. For specialist malting barley quality protection, specialist brokers can access additional endorsements or products from specialist markets that specifically address the malting quality downgrade scenario. Discuss your contracting arrangements explicitly with a specialist broker to ensure the most appropriate coverage structure.' },
